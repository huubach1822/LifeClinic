        ...
        <div className="home-page-container">
                ...
                <div className='section-2-container d-flex flex-column'>
                    ...
                    <div className="d-flex mt-5 justify-content-between">
                        <div className="section-2-card">
                            ...
                            <button type="button" className="btn btn-primary">See more <FontAwesomeIcon icon={faArrowRight} className="ms-2" /></button>
                        </div>
                        <div className="section-2-card">
                ...
                <div className="slider-container py-4">
                    <Slider {...settings}>
                        {clinics?.map((item, index) => {
                            return (
                                <div className="s-4-card" key={item.ID}>
                                    <img className="s-4-img" alt="" src={`data:image/*;base64,${item.Logo}`}></img>
            ...
            <div className="section-5" style={{ backgroundImage: `url("${banner2}")` }}>
                <div className="s-5-container">
                    ...
                    <button type="button" className="s-5-button btn btn-primary">Book now</button>
                </div>
            </div>
        </div>
    )

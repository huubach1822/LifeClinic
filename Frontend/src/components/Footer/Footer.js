                ...
                <div className="d-flex flex-column flex-fill">
                    <div className="right-footer d-flex flex-fill justify-content-evenly">
                        <div>
                            ...
                            <div className="footer-underline">Book a doctor's appointment</div>
                            <div className="footer-underline">Schedule a hospital visit</div>
                            <div className="footer-underline">Get a health check-up</div>
                            <div className="footer-underline">Read our blog</div>
                        </div>
                        <div>
                            <div className="footer-title">Support</div>
                            <div className="footer-underline">About LifeClinic</div>
